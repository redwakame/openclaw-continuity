...
metadata: {"os":["darwin","linux"],"requires":{"bins":["python3"],"env":["OPENCLAW_STATE_DIR","OPENCLAW_CONFIG_PATH"]},"openclaw":{"os":["darwin","linux"],"requires":{"bins":["python3"],"env":["OPENCLAW_STATE_DIR","OPENCLAW_CONFIG_PATH"]}}}
---
